...
//http://localhost/test/kolears/category.php?callback=jsonpcallback&id=123
$(document).ready(function(){


$.getJSON("http://euclid-infotech.com/services/category.php?callback=jsonpcallback&id=123",
{
  format: "json"
},
...
var serviceURL = "http://localhost/test/kolears/";
...
function getcategorylist() 
{
	...
	$.getJSON(serviceURL + 'category.php', function(data) 
	{
		...
		{
			var cat_html = '<a class="menu-item menu-icon img" id="sub-menu-one" href="'+catg.cat_id+'">'+catg.cat_name+'</a>';
